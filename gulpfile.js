...
gulp.task('rollup:umd', function () {
  return gulp.src(`${buildFolder}/**/*.js`)
    ...
    .pipe(rollup({
      ...
      name: 'ngx-responsive-stack-table',
    ...
    .pipe(rename('ngx-responsive-stack-table.umd.js'))
    .pipe(gulp.dest(distFolder));
});
...
/**
 * 12. Copy ngx-responsive-stack-table from /src/css to /dist
 */
gulp.task('copy:stylesheets', function () {
  return gulp.src([`${srcFolder}/css/ngx-responsive-stack-table.css`])
    .pipe(gulp.dest(distFolder));
});
